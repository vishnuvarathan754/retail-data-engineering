# 🛍️ Decathlon Retail Data Engineering Project
...
- Inventory optimization (low stock, overstock)
...
## 🧠 Key Learning
- Fixed file format issues (CSV vs Excel)
- Handled column naming problems
- Solved data type conversion issues
